...
public class PacketInputStream extends BufferedInputStream {
	...
	public Packet readPacket() throws IOException {
		...
		return new Packet(new Context(ctxHigh, ctxLow), source, request, records.toArray(RECORD_ARRAY));
	}
	...
	private byte[] readBytes(int n) throws IOException {
		...
		while (bytesRead < n) {
			bytesRead += in.read(data, bytesRead, n - bytesRead);
		}
		return data;
	}
}
